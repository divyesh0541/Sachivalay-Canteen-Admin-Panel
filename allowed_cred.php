...
<?php
	...
	// fetch records
	$fetch_id = $_GET['id'];
	$select = mysqli_query($conn, "SELECT * FROM users WHERE id = '$fetch_id' ");
...
<?php  
	...
	$update = mysqli_query($conn,"UPDATE users SET password = '$hash_password', status = 'allowed' WHERE id = '{$_GET['id']}' ");
