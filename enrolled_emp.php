...
<?php  
	...
	$emp = mysqli_query($conn,"SELECT * FROM users WHERE status = 'allowed'");
	...
	if (mysqli_num_rows($admin)>0)
       {
            echo "
	            ...
	            <div class='bread_crumb'>
	            	<label><a href='home.php' class='a_left'>Home</a>/<a href='enrolled_emp.php' class='a_right'>Enrolled Employees</a></label>
	            </div>
	            <div class='allow_listing'>
					...
					$i=1;
					while ($emp_row = mysqli_fetch_row($emp)) 
					{
						echo '
								...
								<tr>
									...
									<td>'.$emp_row['5'].'</td>
									<td>'.$emp_row['4'].'</td>
									<td><a href="enrolled_emp_details.php?id='. $emp_row['0'] .'">View</a></td>
								</tr>
