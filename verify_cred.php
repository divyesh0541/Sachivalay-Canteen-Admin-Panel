...
<?php  
	...
	$pending_cred = mysqli_query($conn,"SELECT * FROM users WHERE status = 'pending'");
	...
	if (mysqli_num_rows($admin)>0)
       {
            echo "
	            ...
	            <div class='bread_crumb'>
	            	<label><a href='home.php' class='a_left'>Home</a>/<a href='verify_cred.php' class='a_right'>Verify Employees</a></label>
	            </div>
					...
					while ($pending_cred_row = mysqli_fetch_row($pending_cred)) 
					{
						echo '
								...
								<tr>
									...
									<td>'.$pending_cred_row['2'].'</td>
									<td>'.$pending_cred_row['5'].'</td>
									<td>'.$pending_cred_row['4'].'</td>
									<td><a href="verify_cred_details.php?id='. $pending_cred_row['0'] .'">View</a></td>
								</tr>
